...
public class SensorTests {
    ...
    public void testCreateSensor() {
        ...
        Sensor sensor = new Sensor(99.5923600049, true, 0.0, "ICRAWCRO3", LocalDateTime.parse("2018-08-29 18:09:00", DateTimeFormatter.ofPattern(SensorCSVParser.DATE_TIME_PATTERN)),"Weather",-1.778519,54.965347);
